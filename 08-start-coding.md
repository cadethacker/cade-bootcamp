...
If somebody wants to follow along and use Golang and MySQL, they should have little problem working within their stack and following along. 


## Goal

Setup your dev environment on your laptop and run a simple "hello world" app. 
...
Also, I will not give every last detail on how to accomplish some of these goals.  This will help you to learn to depend on Google for figure out some of the "sharp edges".
...
IntelliJ is one of the the best Java IDE on the market. But IDEs are like people's kitchens.  They have them setup exactly as they want, and cooking in somebody else's kitchen can be frustrating. (Where are the whisks! and the Whisky!)
...
1. Open IntelliJ. You should see with the splash screen. Click on "Create New Project".  If you don't see the splash screen then click `File --> New --> Project`

<img src="08-01-spash-screen.png" height="500">

2. You will then see a list of tons of quick start templates.  Choose `Java` at the top left, and just makesure the Project SDK is defined.  If not, click New and follow the steps to define a JDK.  See the section above from Java8.  

<img src="08-02-new-project.png" width="500">

3.  Check the "Create project from Template" and choose "Java Hello World"

<img src="08-03-template-hello-world.png" width="500">

4.  Specify a Project Name and where you want the files to be placed on the file system
...
7.  Now lets run our simple project

<img src="08-07-run-main.png" width="500">

8.  This will open standard out at the bottom of the project window
...
Quick steps to run with step through debugger. One of the most powerful tools in your programming toolbox. Lets run the exact same steps as above but this time with debug turned on and with a breakpoint. 
...
3. You will now see the breakpoint "hit" and the code execution will halt.  It will wait here indefinitly

<img src="08-11-breakpoint-execute.png" width="500">

4. The debugging panel will appear to the bottom. There are a bazillion options. but lets focus on just a handful of key tools:
...
* To the right of the word "console" are a set of blue arrows. These are very powerful, and will become your best friends.  We will cover them in more details in the future, but set some break points and have fun playing and learning.  They are:
  * Step Over
  * Step Into
  * Step Out
  * Run to Cursor
